...
En Solutech tratamos los datos que nos facilitan los interesados con la máxima transparencia y seguridad, cumpliendo con el RGPD y la LOPDGDD.
...
- **Correo electrónico:** xavi@solutech.blog
...
- **Rectificación:** Corregir tus datos si son inexactos.
...
Envía un correo a **xavi@solutech.blog** indicando tu nombre, el derecho que deseas ejercer y una copia de tu DNI para verificar tu identidad. Responderemos en un plazo máximo de 30 días.
...
- Comunicaciones cifradas mediante certificado SSL/TLS (HTTPS).
- Base de datos alojada en servidor privado con acceso restringido por API Key.
- Copias de seguridad periódicas del sistema.
- Acceso administrativo protegido por autenticación y conexión SSH.

### 9. Cookies
Este sitio web utiliza cookies técnicas y de análisis (Google Analytics) para mejorar la experiencia de navegación y comprender cómo los usuarios interactúan con la web. Puedes configurar tu navegador para rechazar cookies o ser notificado cuando se envíen.
